...
export function AccountProfileForm({
  ...
  async function saveProfile(e: React.FormEvent) {
    ...
    setProfileMsg(null);
    const { ok, data } = await postJson("/api/account/profile", { firstName, lastName, mobile, landline }, "PATCH");
  ...
  return (
    <div className="account-dashboard">
      ...
      <form className="account-card" onSubmit={saveProfile}>
        ...
        <PhoneInput label={t.auth.mobile} required value={mobile} onChange={setMobile} />
        <PhoneInput label={t.auth.landline} value={landline} onChange={setLandline} placeholder={t.auth.landlinePlaceholder} />
